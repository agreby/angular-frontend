  ...
  template: `
    <div class="w-56 bg-white border-r border-gray-200 flex flex-col h-full">
      <div class="p-4 flex items-center">
        ...
        <span class="text-lg font-semibold">Good Mail</span>
      </div>
        ...
        <ul>
          ...
          <li>
            <a 
              ...
              routerLinkActive="text-blue-600 bg-blue-50"
              class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 pl-12"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 mr-3">
      ...
      <div class="mt-auto">
        <ul>
          ...
          <li>
            <a href="#" class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 mr-3">
